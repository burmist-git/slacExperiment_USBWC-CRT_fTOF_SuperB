...
int main(int argc, char** argv)
{
  ...
  if(argc!=8){
    G4cout<<" ERROR of the input parameters !!! "<<G4endl
	  ...
	  <<"      [4] - particle momentum in MeV/c"<<G4endl
	  <<"      [5] - particle theta in deg"<<G4endl
	  <<"      [6] - particle phi in deg"<<G4endl;
    return 0;    
  }
  else{
    G4cout<<"  Input parameters         "<<G4endl
	  ...
	  <<"     particle momentum     "<<argv[5]<<G4endl
	  <<"     particle theta        "<<argv[6]<<G4endl
	  <<"     particle phi          "<<argv[7]<<G4endl;
  }
