Int_t fit2GaussNNN(){
  ...
  file1 = "../../Histos/4/Histos_merged_RUN4_y.root";
  TGraph *gr_sigN = new TGraph();
  TGraph *gr_sigW = new TGraph();
  TGraph *gr_frN = new TGraph();
  fit2GaussNN(dtID, file1, gr_sigN, gr_sigW, gr_frN, 21, kBlack);
...
*/  
  ...
  */
  ...
  fit2GaussNN(dtID, file1, gr_sigN_recotrk, gr_sigW_recotrk, gr_frN_recotrk, 21, kRed);
  */
  ...
  */
  ...
  /*
  file1 = "../../Histos/3/Histos_merged_RUN2_Thesis.root";
  TGraph *gr_sigN_recotrk = new TGraph();
  TGraph *gr_sigW_recotrk = new TGraph();
  TGraph *gr_frN_recotrk  = new TGraph();
  fit2GaussNN(dtID, file1, gr_sigN_recotrk, gr_sigW_recotrk, gr_frN_recotrk, 21, kRed);
...
Double_t *fit2GaussN(Int_t chID, TString file1, TString dTID){
  ...
  TCanvas *c1 = new TCanvas("c1","first fit",10,10,700,800);  
  ...
  TCanvas *c2 = new TCanvas(c2name.Data(),c2title.Data(),20,20,700,800);
  ...
  leg->AddEntry(h1dTime, "Meas","lp");
  leg->AddEntry(g22,     "Narrow comp.","lp");
  leg->AddEntry(g12,     "Wide comp.","lp");
  leg->Draw();
