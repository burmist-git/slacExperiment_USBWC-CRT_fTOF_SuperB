Int_t diffConfCompXYint(){

  TString file1;
  TString file2;
  
  file1 = "../../Histos/Histos_crt_all.root.root";
  file2 = "../../Histos/3/Histos_merged_RUN4_xInt_yInt.root";
  TFile *f1 = new TFile(file1.Data());
  TFile *f2 = new TFile(file2.Data());
  
  TH1D *h1_f1_1 = (TH1D*)f1->Get("h1_Xint_fTOF");
  TH1D *h1_f1_2 = (TH1D*)f1->Get("h1_Yint_fTOF");
  TH1D *h1_f2_1 = (TH1D*)f2->Get("h1x_FTOF_top");
  TH1D *h1_f2_2 = (TH1D*)f2->Get("h1y_FTOF_top");

  //                  hh1     color    Devidor  rebin   normMax error
  normalisationH1D( h1_f1_1, kBlack,    1.0,     4,        1,    0);
  normalisationH1D( h1_f1_2, kBlack,    1.0,     4,        1,    0);
  normalisationH1D( h1_f2_1, kRed,      1.0,     4,        1,    0);
  normalisationH1D( h1_f2_2, kRed,      1.0,     4,        1,    0);
