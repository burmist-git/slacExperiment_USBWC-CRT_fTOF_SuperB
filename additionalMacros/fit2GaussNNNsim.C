Int_t fit2GaussNNNsim(){
  ...
  /*
  file1 = "../../HistosSim/3/003/Histos_fTOFslacCRT_QUARTZ_fTOF.root";
  TGraph *gr_sigN_003S = new TGraph();
  TGraph *gr_sigW_003S = new TGraph();
  TGraph *gr_frN_003S = new TGraph();
  fit2GaussNN(dtID_1, file1, gr_sigN_003S, gr_sigW_003S, gr_frN_003S, 21, kBlack);
  TGraph *gr_sigN_003Sf = new TGraph();
  TGraph *gr_sigW_003Sf = new TGraph();
  TGraph *gr_frN_003Sf = new TGraph();
  fit2GaussNN(dtID_2, file1, gr_sigN_003Sf, gr_sigW_003Sf, gr_frN_003Sf, 20, kBlack);


  file1 = "../../HistosSim/3/004/Histos_fTOFslacCRT_QUARTZ_fTOF.root";
  TGraph *gr_sigN_004S = new TGraph();
  TGraph *gr_sigW_004S = new TGraph();
  TGraph *gr_frN_004S = new TGraph();
  fit2GaussNN(dtID_1, file1, gr_sigN_004S, gr_sigW_004S, gr_frN_004S, 21, kRed);
  TGraph *gr_sigN_004Sf = new TGraph();
  TGraph *gr_sigW_004Sf = new TGraph();
  TGraph *gr_frN_004Sf = new TGraph();
  fit2GaussNN(dtID_2, file1, gr_sigN_004Sf, gr_sigW_004Sf, gr_frN_004Sf, 20, kRed);
  */

  /*
  file1 = "../../HistosSim/3/0045/Histos_fTOFslacCRT_QUARTZ_fTOF.root";
  TGraph *gr_sigN_0045S = new TGraph();
  TGraph *gr_sigW_0045S = new TGraph();
  TGraph *gr_frN_0045S = new TGraph();
  fit2GaussNN(dtID_1, file1, gr_sigN_0045S, gr_sigW_0045S, gr_frN_0045S, 21, kBlue);
  TGraph *gr_sigN_0045Sf = new TGraph();
  TGraph *gr_sigW_0045Sf = new TGraph();
  TGraph *gr_frN_0045Sf = new TGraph();
  fit2GaussNN(dtID_2, file1, gr_sigN_0045Sf, gr_sigW_0045Sf, gr_frN_0045Sf, 20, kBlue);
  */

  /*
  file1 = "../../HistosSim/3/005/Histos_fTOFslacCRT_QUARTZ_fTOF.root";
  TGraph *gr_sigN_005S = new TGraph();
  TGraph *gr_sigW_005S = new TGraph();
  TGraph *gr_frN_005S = new TGraph();
  fit2GaussNN(dtID_1, file1, gr_sigN_005S, gr_sigW_005S, gr_frN_005S, 21, kGreen);
  TGraph *gr_sigN_005Sf = new TGraph();
  TGraph *gr_sigW_005Sf = new TGraph();
  TGraph *gr_frN_005Sf = new TGraph();
  fit2GaussNN(dtID_2, file1, gr_sigN_005Sf, gr_sigW_005Sf, gr_frN_005Sf, 20, kGreen);



  file1 = "../../HistosSim/3/007/Histos_fTOFslacCRT_QUARTZ_fTOF.root";
  TGraph *gr_sigN_007S = new TGraph();
  TGraph *gr_sigW_007S = new TGraph();
  TGraph *gr_frN_007S = new TGraph();
  fit2GaussNN(dtID_1, file1, gr_sigN_007S, gr_sigW_007S, gr_frN_007S, 21, kMagenta);
  TGraph *gr_sigN_007Sf = new TGraph();
  TGraph *gr_sigW_007Sf = new TGraph();
  TGraph *gr_frN_007Sf = new TGraph();
  fit2GaussNN(dtID_2, file1, gr_sigN_007Sf, gr_sigW_007Sf, gr_frN_007Sf, 20, kMagenta);
  */

  file1 = "../../HistosSim/3/014/Histos_fTOFslacCRT_QUARTZ_fTOF.root";
  ...
  TGraph *gr_sigN_042S = new TGraph();
  TGraph *gr_sigW_042S = new TGraph();
  TGraph *gr_frN_042S = new TGraph();
  fit2GaussNN(dtID_1, file1, gr_sigN_042S, gr_sigW_042S, gr_frN_042S, 22, kRed);
  TGraph *gr_sigN_042Sf = new TGraph();
  TGraph *gr_sigW_042Sf = new TGraph();
  TGraph *gr_frN_042Sf = new TGraph();
  fit2GaussNN(dtID_2, file1, gr_sigN_042Sf, gr_sigW_042Sf, gr_frN_042Sf, 23, kRed);



  file1 = "../../HistosSim/3/07/Histos_fTOFslacCRT_QUARTZ_fTOF.root";
  TGraph *gr_sigN_07S = new TGraph();
  TGraph *gr_sigW_07S = new TGraph();
  TGraph *gr_frN_07S = new TGraph();
  fit2GaussNN(dtID_1, file1, gr_sigN_07S, gr_sigW_07S, gr_frN_07S, 22, kBlue);
  TGraph *gr_sigN_07Sf = new TGraph();
  TGraph *gr_sigW_07Sf = new TGraph();
  TGraph *gr_frN_07Sf = new TGraph();
  fit2GaussNN(dtID_2, file1, gr_sigN_07Sf, gr_sigW_07Sf, gr_frN_07Sf, 23, kBlue);
  */


  /*
  file1 = "../../Histos/3/Histos_merged_RUN4.root";
  TGraph *gr_sigN = new TGraph();
  TGraph *gr_sigW = new TGraph();
  TGraph *gr_frN  = new TGraph();
  fit2GaussNN(dtID, file1, gr_sigN, gr_sigW, gr_frN, 21, kRed);



  file1 = "../../Histos/3/Histos_merged_RUN4_5nSigCut.root";
  TGraph *gr_sigN_nSigCut = new TGraph();
  TGraph *gr_sigW_nSigCut = new TGraph();
  TGraph *gr_frN_nSigCut  = new TGraph();
  fit2GaussNN(dtID, file1, gr_sigN_nSigCut, gr_sigW_nSigCut, gr_frN_nSigCut, 21, kBlue);


  file1 = "../../Histos/3/Histos_merged_RUN4_recotrk.root";
  TGraph *gr_sigN_recotrk = new TGraph();
  TGraph *gr_sigW_recotrk = new TGraph();
  TGraph *gr_frN_recotrk  = new TGraph();
  fit2GaussNN(dtID, file1, gr_sigN_recotrk, gr_sigW_recotrk, gr_frN_recotrk, 23, kRed);
  */

  /*
  file1 = "../../Histos/3/Histos_merged_RUN4_recotrk_kinemcut.root";
  TGraph *gr_sigN_kincut = new TGraph();
  TGraph *gr_sigW_kincut = new TGraph();
  TGraph *gr_frN_kincut  = new TGraph();
  fit2GaussNN(dtID, file1, gr_sigN_kincut, gr_sigW_kincut, gr_frN_kincut, 21, kMagenta);
  */
