Int_t diffConfCompDataRate(){

  TString file1;
  TString file2;
  
  file1 = "../../Data/3/merged_RUN4.root";
  TFile *f1 = new TFile(file1.Data());
  
  TH1D *h1_f1_1 = (TH1D*)f1->Get("h1dTimeConsCRT");
  TH1D *h1_f1_2 = (TH1D*)f1->Get("h1dTimeConsUSB");
  TH1D *h1_f1_3 = (TH1D*)f1->Get("h1dTimeConsUSBCRT");

  //                  hh1     color Devidor  rebin   normMax error
  normalisationH1D( h1_f1_1, kBlack,  1.0,     0,        1,    0);
  normalisationH1D( h1_f1_2, kRed,    1.0,     0,        1,    0);
  normalisationH1D( h1_f1_3, kBlue,   1.0,     0,        1,    0);
