...
Int_t diffConfCompData_vs_MC(){
  ...
  //file2 = "../../HistosSim/4/014/Histos_fTOFslacCRT_QUARTZ_fTOF.root";  
  //file2 = "../../HistosSim/4/014/Histos_fTOFslacCRT_QUARTZ_fTOF_01.root";  
  ...
  //L3
  //2 3 10 11	  
  //histName_f1_1 = "h1dTimeL3_ch2";
  //histName_f2_1 = "h1dTimeL3_S_ch2";
  //histName_f2_2 = "h1dTimeL3_first_ch2";
  ...
  normalisationH1D( h1_f1_1, kBlack,    1.0,     3,        1,    1);
  normalisationH1D( h1_f2_1, kBlue,     1.0,     3,        1,    0);
  normalisationH1D( h1_f2_2, kRed,      1.0,     3,        1,    0);
  
  //alignment( h1_f1_1, 0.0, 1);
  //alignment( h1_f2_1, 0.0, 0);
  //alignment( h1_f2_2, 0.0, 0);

  Double_t deltaT = -0.6798;

  alignment( h1_f1_1, deltaT, 1);
  alignment( h1_f2_1, deltaT, 0);
  alignment( h1_f2_2, deltaT, 0);

  gStyle->SetFrameBorderMode(0);
  gROOT->ForceStyle();
  gStyle->SetOptStat(kFALSE);
  
  TCanvas *c1 = new TCanvas("c1","plots",10,10,700,800);
  c1->Clear();
  ...
  h1_f1_1->Draw();
  h1_f1_1->GetXaxis()->SetRangeUser(-2.0 + deltaT,2.0 + deltaT);
  ...
  leg->AddEntry(h1_f1_1, "Meas.","lp");
  leg->AddEntry(h1_f2_2, "First p.e.","lp");
  leg->AddEntry(h1_f2_1, "Wave. sim.","lp");
  leg->Draw();
